...
import FollowsInfos from "../components/FollowingInfo"
import { Link } from "react-router-dom"


export default function Following() {
    const { logout, token, followingInfo, setFollowingInfo} = useContext(AuthContext)
    ...
    return(
        <>
            ...
            {followingInfo.length > 0  ?
                <FollowsInfos followingInfo={followingInfo} /> 
                : 
